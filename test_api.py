...
if __name__ == "__main__":
    ...
    # test_send_prompt(created_session.session_id, "this is a test prompt")
    ...
    # test_api_update_context_strategy(created_session_for_pt_cs.session_id, context_strategy_name)
    ...
    # test_api_update_prompt_template(created_session_for_pt_cs.session_id, prompt_template_name)

    # updated_session = Session(session_id = created_session_for_pt_cs.session_id)
    # # print(f"Updated context strategy:{updated_session.context_strategy}")
    # # print(f"Updated prompt template:{updated_session.prompt_template}")
    ...
    a = api_get_session(session_id = "my-new-session_20240310-234259")
    print(a.metadata.session_id)