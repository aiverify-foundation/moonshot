...
from moonshot.src.utils.import_modules import create_module_spec, get_instance, import_module_from_spec
...
class TestCollectionImportModules:
    ...
    def test_import_module_from_spec(self):
        ...
        module_spec = create_module_spec(
            "module_name", self.valid_module_file_path
        )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("OpenAIConnector", valid_module_file_path, "<class 'OpenAIConnector.OpenAIConnector'>"),
