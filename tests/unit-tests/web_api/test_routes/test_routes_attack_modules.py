...
@pytest.mark.parametrize("attack_module_data, exception, expected_status, expected_response", [
    ...
    ([], None, 200, []),
    # Exception cases
    (None, ServiceException("A file not found error occurred", "get_all_attack_module", "FileNotFound"), 404, "A file not found error occurred"),
    (None, ServiceException("A validation error occurred", "get_all_attack_module", "ValidationError"), 400, "A validation error occurred"),
    (None, ServiceException("An server error occurred", "get_all_attack_module", "ServerError"), 500, "An server error occurred"),
])
...
@pytest.mark.parametrize("exception, expected_status, expected_response", [
    ...
    # Exception cases
    (ServiceException("A file not found error occurred", "get_all_attack_module_metadata", "FileNotFound"), 404, "A file not found error occurred"),
    (ServiceException("A validation error occurred", "get_all_attack_module_metadata", "ValidationError"), 400, "A validation error occurred"),
    (ServiceException("An server error occurred", "get_all_attack_module_metadata", "ServerError"), 500, "An server error occurred"),
])
