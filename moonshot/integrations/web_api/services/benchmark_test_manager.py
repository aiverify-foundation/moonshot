...
from ..status_updater.interface.benchmark_progress_callback import InterfaceBenchmarkProgressCallback
...
class BenchmarkTestManager(BaseService):
    ...
    def add_task(self, executor_id: str, task: asyncio.Task[Any], moonshot_runner: Runner) -> None:
    ...
    async def run_test(self, benchmark_input_data: BenchmarkRunnerDTO, benchmark_type : BenchmarkCollectionType, moonshot_runner: Runner) -> None:
        try:
    ...
    async def schedule_test_task(self, input_data: BenchmarkRunnerDTO, benchmark_type : BenchmarkCollectionType) -> str:
