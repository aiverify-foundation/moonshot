...
class HomoglyphGenerator(AttackModule):
    ...
    async def execute(self):
        ...
        self.load_modules()
        self.description = (
            "This attack creates homoglyphs for words in a prompt. Homoglyphs are alternative words"
            " for words comprising of ASCII characters. Example of a homoglyph fool -> fooI"
        )
