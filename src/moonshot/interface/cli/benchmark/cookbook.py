...
def add_cookbook(args) -> None:
    ...
    api_add_new_cookbook(args.name, args.description, recipes)
...
def list_cookbooks() -> None:
    ...
    """
    cookbooks_list = api_get_all_cookbooks()
    if cookbooks_list:
...
def view_cookbook(args) -> None:
    ...
    """
    cookbook_info = api_get_cookbook(args.cookbook)
    name, description, recipes = cookbook_info.values()
    recipes_list = api_get_recipes(recipes)
    if recipes_list:
