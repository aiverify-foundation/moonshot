...
from moonshot.api import api_get_bookmark,api_export_bookmarks,api_delete_bookmark,api_insert_bookmark,api_get_all_bookmarks,api_delete_all_bookmark
...
# print("\n\nGetting 1 bookmark")
# print(api_get_bookmark("my bookmark 1"))

# print("\n\nDeleting all")
# print(api_delete_all_bookmark())

# print(api_get_all_bookmarks())

print(api_export_bookmarks())