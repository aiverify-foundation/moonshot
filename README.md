...
2. Virtual Environment (This is optional but we recommend you to separate your dependencies)
    ...
    ```
3. If you plan to install our Web UI, you will also need [Node.js verion 20.11.1 LTS](https://nodejs.org/en/blog/release/v20.11.1) and above
</br>
