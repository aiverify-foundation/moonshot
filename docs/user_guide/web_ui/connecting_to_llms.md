...
3. Select the endpoints to the AI systems that you wish to run benchmarks on, and click the next button when done. 
    ...
    Click on ‘Edit’ for Together Llama Guard 8B Assistant, provide your API token, and click ‘Save’. (You don’t need to select Together Llama Guard 8B Assistant for testing. This is necessary to run some of the cookbooks like MLCommon's AI Safety Benchmark.) 
